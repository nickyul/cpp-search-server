...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus ex_status) const {
        return FindTopDocuments(raw_query, [ex_status](int document_id, DocumentStatus status, int rating) {return status == ex_status; });
    }
